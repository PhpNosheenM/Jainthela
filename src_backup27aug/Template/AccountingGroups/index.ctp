...
<div class="page-content-wrap">
        <div class="page-title">                    
            <h2><span class="fa fa-arrow-circle-o-left"></span>Accounting Groups</h2>
        </div> 
    <div class="row">
                <div class="col-md-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Create Accounting Groups</h3>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>                                            
											...
											<?php
											$accountingGroup_id = $EncryptingDecrypting->encryptData($accountingGroup->id);
											?>
                                            <tr>
                                            ...
                                            <td class="actions">
											<?php if(!empty($accountingGroup->parent_accounting_group->name)){ ?>
                                            <?= $this->Html->link(__('<span class="fa fa-pencil"></span>'), ['action' => 'index', $accountingGroup_id],['class'=>'btn btn-primary  btn-condensed btn-sm','escape'=>false]) ?>
											<?php } ?>
                                            </td>
                                            </tr>
                                            <?php endforeach; ?>
