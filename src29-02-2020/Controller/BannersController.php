...
class BannersController extends AppController
{
	public function beforeFilter(Event $event)
    {
        ...
        $this->Security->setConfig('unlockedActions', ['index','cronUpdate']);
    ...
    public function index($ids = null)
    {
        ...
        if ($this->request->is(['post','put'])) {
			...
			$banner_image=$this->request->data['banner_images'];
			...
			$banner->last_date=date('Y-m-d', strtotime($last_date));
		...
		$this->set(compact('banners','banner','paginate_limit','categories','Items','Sellers','ComboOffers','ItemVariationMasters','variation_options', 'updt_id'));
    }
