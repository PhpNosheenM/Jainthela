							...
							<table class="table table-bordered main_table">
								...
								<tbody class="MainTbody">  
									<tr class="MainTr">
										...
										<td>
											<?php echo $this->Form->input('extra', ['label' => false,'class' => 'extra form-control input-sm number amnt','placeholder'=>'rate' ,'readonly'=>'readonly']); ?>
										</td>
										<td>
											<?php echo $this->Form->input('discount', ['max'=>100,'label' => false,'class' => 'form-control input-sm discount','placeholder'=>'Discount']); ?>
										</td>
										<td>
