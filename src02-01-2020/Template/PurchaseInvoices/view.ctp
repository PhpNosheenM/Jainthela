...
<div  class="maindiv" style="border:solid 1px #c7c7c7;background-color: #FFF;padding: 10px;margin: auto;width:65%;font-size: 12px; ">	
	<table width="100%" class="divHeader">
		<tbody><tr>
				...
				<td align="center" width="40%" style="font-size: 12px;"><div align="center" style="font-size: 18px;font-weight: bold;color: #0685a8;"> Purchase Invoice </div></td>
				<td align="right" width="40%" style="font-size: 12px;">
				<span style="font-size: 14px;font-weight: bold;"><?= @$company_details->firm_name ?></span><br/>
				<span style="align:left"><?= @$company_details->firm_address ?></span></br>
			...
			<td width="50%" valign="top" align="left">
				<table>
					...
					<tr>
						<td>Party</td>
						<td width="20" align="center">:</td>
						<td><?= $purchaseInvoice->seller_ledger->name ?></td>
					</tr>
			...
			<td width="50%" valign="top" align="right">
				<table>
					<tr>
						...
						<td width="20" align="center">:</td>
						<td><?= $purchaseInvoice->transaction_date ?></td>
					</tr>
					<tr>
						<td>Party Invoice Number</td>
						<td width="20" align="center">:</td>
						<td><?= $purchaseInvoice->party_invoice_no ?></td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<table class="GeneratedTable">
		...
		<tbody>
			...
			<tr>
				<td colspan="9" style="text-align:right"><b>Freight/Labour</b></td>
				<td style="text-align:right"><b><?php echo $purchaseInvoice->freight_amount; ?></b></td>
			</tr>
			<tr>
				<td colspan="9" style="text-align:right"><b>Total</b></td>
				<td style="text-align:right"><b><?php echo $purchaseInvoice->total_amount; ?></b></td>
			</tr>
