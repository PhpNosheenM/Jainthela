				        ...
				        <table class="table table-bordered">
					       ...
					       <tbody>                                            
								...
								<tr>
									...
									<td class="actions">
										<?php
											$term_data_id = $EncryptingDecrypting->encryptData($term_data->id);
										?>
										<?= $this->Html->link(__('<span class="fa fa-pencil"></span>'), ['action' => 'index', $term_data_id],['class'=>'btn btn-primary  btn-condensed btn-sm','escape'=>false]) ?>
										<?= $this->Form->postLink('<span class="fa fa-remove"></span>', ['action' => 'delete', $term_data_id], ['class'=>'btn btn-danger btn-condensed btn-sm','confirm' => __('Are you sure you want to delete?'),'escape'=>false]) ?>
									</td>
								</tr>
					            <?php endforeach; ?>
					       </tbody>
