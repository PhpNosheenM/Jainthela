...
<?php $this->set('title', 'View'); ?>
	<div style="background-color: #FFF;padding:10px;width: 100%;font-size:14px;" class="maindiv">	
		...
		<div class="col-md-12" >
		 ...
		 <div class="col-md-12" >
			...
			<div class="col-md-10"  align="center" style="color:#F98630; font-size: 16px;font-weight: bold;">
	...
	<div style="border:solid 2px #F98630; margin-bottom:0px;"></div>
		<table width="100%">
			<tbody>
				<tr style="background-color:#fff; color:#000;">
					<td align="left" colspan="5">
						<b>
							...
							<br>Order No.: <?= $sales_orders->order_no ?>
						</b>
					</td>
				</tr>
				<?php
				foreach($sales_orders->customer->customer_addresses as $address_data){
					...
					@$landmark=$address_data->landmark_name;
				...
				<tr style="background-color:#fff; color:#000;">
					...
					<b>Address: </b><?php echo $house_no.'-'.$landmark; ?><br>
			...
			<table width="100%" border="1">
				...
				<tr style="background-color:#fff; border-top:1px solid #000">
					<td colspan="12">&nbsp;</td><td align="center"><b>Discount Amount</b></td>
					<td align="center"><b><?= h(@$sales_orders->discount_amount) ?></b></td>
				</tr>
				<tr style="background-color:#fff; border-top:1px solid #000">
					<td colspan="12">&nbsp;</td><td align="center"><b> Taxable Amount</b></td>
		...
		<fieldset>
			...
			<div>
				<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; text-align: justify; line-height: normal; mso-outline-level: 1;"><strong><span style="font-size: 12.0pt; font-family: 'Times New Roman','serif'; mso-fareast-font-family: 'Times New Roman'; mso-font-kerning: 18.0pt;">Order Comment</span></strong></p>
