...
<?php $this->set('title', 'Order'); ?><!-- PAGE CONTENT WRAPPER -->
							...
							<tbody>
								...
								<?php } ?> height="40px" >
									...
									<span id="al"></span>
										...
										<?php if($order->order_status=='placed' && $order->order_status!='Cancel'){ ?>
											 ...
											 <div class="modal animated fadeIn ccl" id="modal_change_photo_<?php echo $ordr_id; ?>" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
									...
									<td>
										<a href="pdf1/<?php echo $order_id; ?>" class="btn btn-success btn-condensed btn-sm" >Invoice</a>
									</td>
