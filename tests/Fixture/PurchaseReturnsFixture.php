...
class PurchaseReturnsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'invoice_no' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'seller_ledger_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created_by' => 1,
            'edited_by' => 1,
            'created_on' => 1530080088,
            'edited_on' => 1530080088,
            'status' => 'Lorem ip'
        ],
    ];
}
