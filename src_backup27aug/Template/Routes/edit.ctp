		...
		<?= $this->Form->create($route,['id'=>'jvalidate','class'=>'form-horizontal','type'=>'file']) ?>  
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><strong> Route Edit</strong></h3>
				</div>
					...
					<fieldset>
						...
						<div class="">
							<table class="table table-bordered main_table">
								...
								<?php 
									foreach($route->route_details as $data2){ 
								
								?>
									<tr class="MainTr">
										<td width="60%" valign="top">
											<?= $this->Form->select('landmark_id',$landmarks,['empty'=>'---Select--Area---','class'=>'form-control lnd','label'=>false, 'data-live-search'=>true,'value'=>$data2->landmark_id]) ?>
										</td>
										<td width="20%" valign="top">
											<?= $this->Form->control('priority',['class'=>'form-control prty','label'=>false, 'type'=>'number','value'=>$data2->priority]) ?>
										</td>
										<td valign="top"  >
