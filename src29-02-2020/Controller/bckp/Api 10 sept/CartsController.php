		...
		if($exists == 1)
		{
				if($tag=='add')
					...
					else
					{
					  $success = true;
					  $message = 'Cart Data found'; 
					  $this->set(compact('success', 'message','isPromoValidForAll','isPromoValidForAllMsg','Round_off_amt','address_available','delivery_charge_amount','payableAmount','remaining_wallet_amount','carts','item_in_cart','comboData','Combototal','promo_detail_id','ItemWiseTotal_taxable','ItemWiseTotal_With_GST','Combototal_with_GST','TotalBeforeDiscount','Sub_Total','PromoTotal','MembershipTotal','Total_GST'));
...
/* 												$item_id = $cart_data->item_variation->item->id;
		...
		'promo_detail_id','holidays_date','ItemWiseTotal_taxable','ItemWiseTotal_With_GST','Combototal_with_GST','TotalBeforeDiscount','Sub_Total',
	  'PromoTotal','MembershipTotal','Total_GST','Round_off_amt'));
		...
		'carts','ItemWiseTotal_taxable','ItemWiseTotal_With_GST','comboData','Combototal','Combototal_with_GST','TotalBeforeDiscount','Sub_Total',
