				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-md-3">
							...
							<div class="form-group">
								...
								<div class="">  
										...
										<?= $this->Form->select('customer_id',$partyOptions,['empty'=>'---Select--','class'=>'form-control select prty_ldgr','label'=>false,'data-live-search'=>true,'value'=>$Orders->customer_id]) ?>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="">
									...
									<?php }else{ ?>
										<?= $this->Form->control('transaction_date',['class'=>'form-control datepicker','placeholder'=>'Transaction Date','label'=>false,'type'=>'text','data-date-format' => 'dd-mm-yyyy','value'=>$Orders->transaction_date]) ?>
									<?php } ?>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="form-group">
								...
								<div class="">
									<?= $this->Form->control('narration',['class'=>'form-control','placeholder'=>'Narration','label'=>false,'rows'=>'6','value'=>@$Orders->narration]) ?>
								</div>
							</div>
						</div>
					</div>
...
<?php
if(empty($id) && empty($CancelItemOrder)){
