...
<?php $this->set('title', 'Grocery Report');?><!-- PAGE CONTENT WRAPPER -->
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><strong>Consolidated Report For Grocery</strong></h3>
	...
	function show_ledger_data(sel,item_id)
	 {
		...
		var url='".$this->Url->build(["controller" => "Items", "action" => "fetchLedger"])."';
