					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<!--div class="form-group">
								...
								<div class="col-md-9 col-xs-12">
									<?php //$this->Form->control('gstin_holder_name',['class'=>'form-control','placeholder'=>'GSTIN Holder Name','label'=>false]) ?>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">GSTIN Holder Address</label>
								<div class="col-md-9 col-xs-12"> 
									<?php //$this->Form->control('gstin_holder_address',['class'=>'form-control','placeholder'=>'GSTIN Holder Address','label'=>false,'rows'=>'4']) ?>
								</div>
							</div-->
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-xs-12">
									...
									<span class="input-group-addon add-on"> FROM </span>
										<?= $this->Form->control('start_date',['class'=>'form-control datepicker','placeholder'=>'From','label'=>false,'type'=>'text','data-date-format' => 'dd-mm-yyyy','value'=>date('d-m-Y')]) ?>
										<span class="input-group-addon add-on"> TO </span>
										<?= $this->Form->control('end_date',['class'=>'form-control datepicker','placeholder'=>'To','label'=>false,'type'=>'text','data-date-format' => 'dd-mm-yyyy','value'=>date('d-m-Y')]) ?>
										</div>
								</div>
							</div>-->
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-xs-12">
									<?= $this->Form->control('default_credit_days',['type'=>'number','class'=>'form-control','placeholder'=>'Default Credit Days','label'=>false,'value'=>0]) ?>
								</div>
							</div>
								...
								<tbody class="MainTbody">  
									<tr class="MainTr">
										<td width="30%" valign="top">
											<?= $this->Form->control('receiver_name',['class'=>'form-control receiver_name','label'=>false]) ?>
										</td>
										<td width="30%" valign="top">
											<?= $this->Form->control('mobile_no',['class'=>'form-control mobile_no','label'=>false]) ?>
										</td>
										<td width="" valign="top">
										...
										<td>
											<?= $this->Form->select('landmark_id',$Landmarks,['empty'=>'---Select--Landmark---','class'=>'form-control select location_id','label'=>false,'required'=>'required', 'data-live-search'=>true]) ?>
										</td>
...
<table id="sampleTable" width="100%" style="display:none;">
	<tbody class="sampleMainTbody">
		<tr class="MainTr">
			<td width="30%" valign="top">
				<?= $this->Form->control('receiver_name',['class'=>'form-control receiver_name','label'=>false,'rows'=>3]) ?>
			</td>
			<td width="30%" valign="top">
				<?= $this->Form->control('mobile_no',['class'=>'form-control mobile_no','label'=>false,'rows'=>3]) ?>
			</td>
   ...
   $js='var jvalidate = $("#jvalidate").validate({
		...
		function renameRows(){
				...
				$(".main_table tbody tr").each(function(){
						$(this).attr("row_no",i);
						$(this).find(".receiver_name").attr({name:"customer_addresses["+i+"][receiver_name]",id:"customer_addresses-"+i+"-receiver_name"}).rules("add", "required");
						 $(this).find(".mobile_no").attr({name:"customer_addresses["+i+"][mobile_no]",id:"customer_addresses-"+i+"-mobile_no"}).rules("add", "required");
