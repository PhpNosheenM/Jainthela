	...
	<div style="border:solid 1px #c7c7c7;background-color: #FFF; margin-left:100px; margin-right:100px;width: 80%;font-size:14px;" class="maindiv">	
		...
		<table class="GeneratedTable">
			<thead>
				...
				<tr>
					<th colspan="4" style="text-align:center; padding-top:5px;">Orders</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td width="50%" colspan="2">Order No : - <?php echo $Orders->order_no; ?></td>
					<td width="50%"  colspan="2">Transport Mode : -</td>
				</tr>
				
				<tr>
					<td  colspan="2">Order Date : - <?php echo date('d-m-Y',strtotime($Orders->transaction_date)); ?></td>
		...
		<table class="GeneratedTable">
			...
			<tbody>
				...
				<tr>
					<td colspan="9" rowspan="5" style="text-align:center"><b><?php echo $this->NumberWords->convert_number_to_words($total); ?></b></td>
