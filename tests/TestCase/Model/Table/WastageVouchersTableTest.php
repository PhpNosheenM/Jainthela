...
use App\Model\Table\WastageVouchersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\WastageVouchersTable Test Case
 */
class WastageVouchersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\WastageVouchersTable
     */
    public $WastageVouchers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('WastageVouchers') ? [] : ['className' => WastageVouchersTable::class];
        $this->WastageVouchers = TableRegistry::get('WastageVouchers', $config);
    }
