							...
							<table id="MainTable" class="table table-condensed table-striped" width="100%">
								...
								<tbody id='MainTbody' class="tab">
									...
									<tr class="MainTr">
										...
										<td width="65%" valign="top">
											<?php echo $this->Form->select('ledger_id',$ccLedgerOptions, ['empty'=>'--Select--','label' => false,'class' => 'form-control input-sm ledger select','required'=>'required', 'data-live-search'=>true]); ?>
											<div class="window" style="margin:auto;"></div>
										</td>
										<td width="10%" valign="top">
											<?php echo $this->Form->input('debit', ['label' => false,'class' => 'form-control input-sm  debitBox ccevenuecharge rightAligntextClass numberOnly calculate_total','placeholder'=>'Debit']); ?>
										</td>
										<td width="10%" valign="top">
									...
									<tr class="MainTr">
										...
										<td width="65%" valign="top">
											<?php echo $this->Form->select('ledger_id',$tdsLedgerOptions, ['empty'=>'--Select--','label' => false,'class' => 'form-control input-sm ledger select','required'=>'required', 'data-live-search'=>true]); ?>
											<div class="window" style="margin:auto;"></div>
										</td>
										<td width="10%" valign="top">
											<?php echo $this->Form->input('debit', ['label' => false,'class' => 'form-control input-sm  debitBox rightAligntextClass numberOnly calculate_total tds_amount','placeholder'=>'Debit','readonly']); ?>
										</td>
										<td width="10%" valign="top">
											<?php echo $this->Form->input('credit', ['label' => false,'class' => 'form-control input-sm creditBox rightAligntextClass numberOnly calculate_total ','placeholder'=>'Credit','style'=>'display:none;']); ?>	
										</td>
									...
									<tr class="MainTr">
										...
										<td width="65%" valign="top">
											<?php echo $this->Form->select('ledger_id',$bankOptions, ['empty'=>'--Select--','label' => false,'class' => 'form-control input-sm ledger select','required'=>'required', 'data-live-search'=>true]); ?>
											<div class="window" style="margin:auto;"></div>
										</td>
										<td width="10%" valign="top">
											<?php echo $this->Form->input('debit', ['label' => false,'class' => 'form-control input-sm  debitBox ccevenuecharge rightAligntextClass numberOnly calculate_total','placeholder'=>'Debit']); ?>
	...
	<tbody>
		<tr>
			...
			<td width="10%" style="padding-left:0px;" valign="top">
				<?php 
				echo $this->Form->select('type_cr_dr',$option_type, ['label' => false,'class' => 'form-control input-sm  calculation refDrCr','value'=>'Cr']); ?>
			</td>
...
<table id="sampleForBank" style="display:none;" width="100%">
	<tbody>
		<tr>
			...
			<td width="30%" valign="top">
				<?php echo $this->Form->input('tds_per', ['label' =>false,'class' => 'form-control input-sm tds_per positiveValue','placeholder'=>'Tds Percentage']); ?> 
			</td>
	...
	$total_type='<input type="text" class="form-control input-sm total_type calculation noBorder" readonly >';
	 ...
	 $js="var form1 = $('#jvalidate').validate({
		...
		function renameMainRows(){
			...
			$(document).on('keyup', '.ccevenuecharge', function(){ 
				//var SelectedTr=$(this).closest('tr.MainTr');
				var c=$('.ccevenuecharge').val();
				//var c=$('.tds_amount').val();
				var x=$('.tds_per').val();
				var tds=(c*x)/100;
				$('.tds_amount').val(tds);
				renameMainRows();
