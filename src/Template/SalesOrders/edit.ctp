...
<div class="salesOrders form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('sales_order_date');
            echo $this->Form->control('payment_status');
            echo $this->Form->control('sales_order_from');
        ?>
    </fieldset>
