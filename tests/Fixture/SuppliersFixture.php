...
class SuppliersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '1 for continoue and 0 for delete', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created_on' => 1521019479,
            'created_by' => 1,
            'edited_on' => 1521019479,
            'edited_by' => 1,
            'status' => 1
        ],
    ];
