<div class="login-box animated fadeInDown">
                ...
                <div class="login-body">
                    <div class="login-title"><strong>Welcome</strong>, Please login Super Admin</div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
							<?php  echo $this->Html->link("Forgot your password?", array('controller' => 'SuperAdmins', 'action' => 'forgot_password'),['class' => 'btn btn-link btn-block','style'=>'','escape'=>false]); ?>
                        </div>
                        <div class="col-md-6">
