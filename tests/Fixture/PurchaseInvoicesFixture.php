...
class PurchaseInvoicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'purchase_ledger_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'city_id' => 1,
            'created_by' => 1,
            'created_on' => 1521198048,
            'edited_by' => 1,
            'edited_on' => 1521198048
        ],
    ];
}
