				 ...
				 if($isValidCity == 0)
				 {
					...
					if($ComboOffers->toArray()){
						...
						foreach($ComboOffers as $ComboOffer){
							...
							$sold_by = $ComboOffer->sold_by;
							$delivery_time_slot = $ComboOffer->delivery_time_slot;
