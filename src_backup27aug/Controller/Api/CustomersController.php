...
class CustomersController extends AppController
{
  public function initialize()
    {
        parent::initialize();
        $this->Auth->allow(['addAddress','add','push_token_update','login','send_otp','verify','setpassword','sendotpforgetpassword','editProfile','my_account','viewProfile','customerAddresses','removeAddress','']);
    }
