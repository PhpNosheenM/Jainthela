...
<div style="" class="qwerty">
	...
	<span class="sr-only">Close</span>
		...
		<center><h4>INVOICE NUMBER:- <?php echo $Orders->invoice_no; ?></h4></center>
								...
								<table class="table table-condensed table-bordered main_table" id="main_table">
									...
									<tr>
										...
										<td colspan="2" style="text-align:right;">
											...
											<?= $this->Form->control('invoice_id',['class'=>'form-control','type'=>'hidden','readonly','value'=>@$Orders->id]) ?>
										</td>
									</tr>
									<tr>
				...
				<tfoot>
					...
					<tr>
						<td align="right">
							...
							<a class="btn blue get_order" id="submits" invoice_id="<?php echo $invoice_id; ?>" order_id="<?php echo $order_id; ?>" ><i class="fa fa-shopping-cart"></i> Deliver</a>
						</td>
					</tr>
				</tfoot>	
		</table>
