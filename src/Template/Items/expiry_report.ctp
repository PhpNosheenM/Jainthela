												...
												<?php $p=1;  foreach($Data as $data1){  
													...
													?>
														<tr style="background-color:#f27c41">
															<td style="width:10px;background-color: #f27c41;"><?= h($p++) ?></td>
															<td style="width:150px;background-color: #f27c41;"><?= h($data1['qty']) ?></td>
															<td style="width:100px;background-color: #f27c41;"><?= h($data1['rate']) ?></td>
															
															<td style="width:100px;background-color: #f27c41;"><?= h($data1['expiry_date']) ?></td>
														</tr>
													<?php }else{ ?>
														<tr>
															...
															<td style="width:100px;"><?= h($data1['expiry_date']) ?></td>
														</tr>
													<?php } ?>
												<?php  } ?>
											</tbody>
