				...
				<div class="panel-body">    
					<div class="row">
						<div class="col-md-3">
							...
							<div class="form-group">
								<label class=" control-label">Party Invoice No.</label>
								<div class="">                                            
									<?= $this->Form->control('party_invoice_no',['class'=>'form-control ','label'=>false]) ?>
								</div>
							</div>
								<!--<div class="form-group">
							...
							<table class="table table-bordered main_table">
								<thead>
									<tr align="center">
										...
										<th rowspan="2" style="text-align:left;width:300px;"><label>HSN Code<label></th>
										...
										<th rowspan="2" style="text-align:center;width:200px;"><label>GST Type<label></th>
										</tr>
									<tr>
									...
									<tr class="MainTr">
										<td  valign="top">1</td>
										 <td width="">
											...
											<input type="hidden" value="<?php echo $total_grn_row->item->gst_type; ?>" class="gst_type" >
											
										</td>
										<td width="">
											<?php echo $total_grn_row->item->hsn_code;?>
										</td>
										<td width="">
											<?php echo $total_grn_row->unit_variation->visible_variation;
											//echo $total_grn_row->unit_variation->quantity_variation.' ('.$total_grn_row->unit_variation->unit->shortname.')'; ?>
										...
										<td valign="top">
											<?= $this->Form->control('rate',['class'=>'form-control rate','label'=>false,'value'=>$total_grn_row->rate,'readonly']) ?>
										</td>
										...
										<td valign="top">
											<?= $this->Form->select('gst_type',$GstType,['class'=>'form-control select gst_type','label'=>false,'value'=>$total_grn_row->gst_type]) ?>
										</td>
									</tr>
								<?php } ?>
								</tbody>
								<tfoot>
									...
									<tr>
										<td colspan="10" style="text-align:right;">Total Taxable</td>
									...
									<tr>
										<td colspan="10" style="text-align:right;">GST Amount</td>
										<td colspan="1" style="text-align:right;"><?= $this->Form->control('total_gst',['class'=>'form-control gst_amt','label'=>false,'readonly']) ?></td>
									</tr>
									<tr>
										<td colspan="10" style="text-align:right;">Freight/Labour Charge</td>
										<td colspan="1" style="text-align:right;"><?= $this->Form->control('freight_amount',['class'=>' form-control freight_amount','label'=>false]) ?></td>
									</tr>
									<tr>
									...
									<tr class="MainTr">
										<td  valign="top">1</td>
										 <td width="">
											...
											<input type="hidden" value="<?php echo $total_grn_row->item_variation->item->gst_type; ?>" class="gst_type" >
		...
		function calculation(){ 
			...
			$('.main_table tbody tr').each(function(){
				...
				if(gst_type=='excluding'){
					...
					freight_amount=$('.freight_amount').val();
				...
				total_amount=total_amount+freight_amount;
				$('.total_amt').val(round(total_amount,2));
		}
