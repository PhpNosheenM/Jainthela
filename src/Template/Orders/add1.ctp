							...
							<table class="table table-bordered main_table">
								...
								<tfoot>
									<tr>
										...
										<td colspan="2" style="text-align:right;"><?= $this->Form->control('before_discount',['class'=>'form-control before_discount','label'=>false,'readonly','value'=>@$sales_orders->total_amount]) ?></td>
									</tr>
									...
									<tr>
										...
										<td colspan="2" style="text-align:right;"><?= $this->Form->control('amount_from_wallet',['class'=>'form-control wlt_amt','label'=>false,'value'=>@$sales_orders->amount_from_wallet]) ?></td>
									</tr>
									
									<tr>
										<td colspan="12" style="text-align:right;">Final Due Amount</td>
										<td colspan="2" style="text-align:right;"><?= $this->Form->control('due_amount',['class'=>'form-control due_amt','label'=>false,'value'=>@$sales_orders->due_amount]) ?></td>
									</tr>
								</tfoot>
							</table>
   ...
   $js="var jvalidate = $('#jvalidate').validate({
		...
		function calculation1(){
			...
			$('.main_table tbody tr').each(function(){
					...
					var f_gst_dis=round(f_gst_rate1/f_gst_rate2, 2);
			...
			var ttl_amnt=parseFloat($('.total_taxable_value').val());
				...
				var fianl_grand_amount=round(grand_total,2);
				...
				$('.due_amt').val(round(due_amount,2));
				...
				if((cash_back>0)){
				var chk_grnd_amnt=$('.total_amt').val();
