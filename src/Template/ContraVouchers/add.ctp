			...
			function renameRefRows(SelectedTr){
				...
				SelectedTr.find('td:nth-child(2) div.window table tbody tr').each(function(){
					...
					if(is_select){
						...
						$(this).find('td:nth-child(5) input.dueDays').attr({name:'contra_voucher_rows['+row_no+'][reference_details]['+i+'][due_days]',id:'contra_voucher_rows-'+row_no+'-reference_details-'+i+'-due_days'});
					}
