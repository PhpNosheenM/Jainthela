...
use App\Model\Table\StockTransferVouchersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\StockTransferVouchersTable Test Case
 */
class StockTransferVouchersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\StockTransferVouchersTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('StockTransferVouchers') ? [] : ['className' => StockTransferVouchersTable::class];
        $this->StockTransferVouchers = TableRegistry::get('StockTransferVouchers', $config);
    }
    ...
    {
        unset($this->StockTransferVouchers);
