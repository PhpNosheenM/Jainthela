...
/**
 * ItemVariationMastersFixture
 *
 */
class ItemVariationMastersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'unit_variation_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'item_id' => 1,
            'unit_variation_id' => 1,
            'created_on' => 1521626474,
            'edited_on' => 1521626474,
            'created_by' => 1,
            'edited_by' => 1
        ],
    ];
