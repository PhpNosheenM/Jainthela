...
/**
 * ItemReviewRatingsFixture
 *
 */
class ItemReviewRatingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rating' => ['type' => 'decimal', 'length' => 2, 'precision' => 1, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'item_review_ratings_ibfk_1' => ['type' => 'foreign', 'columns' => ['item_id'], 'references' => ['items', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'item_review_ratings_ibfk_2' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
