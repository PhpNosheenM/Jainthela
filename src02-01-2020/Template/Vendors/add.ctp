...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
		<?= $this->Form->create($vendor,['id'=>"jvalidate",'class'=>"form-horizontal",'type'=>'file']) ?>  
		<?php $js=''; ?>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-md-9"> 
										<?= $this->Form->control('registration_date',['autocomplete'=>'off','class'=>'form-control datepicker','placeholder'=>'Registration Date','label'=>false,'type'=>'text','data-date-format' => 'dd-mm-yyyy','value'=>'']) ?> 
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									?>
										<?= $this->Form->control('document_image',['type'=>'file','label'=>false,'id' => 'brand_image','data-show-upload'=>false, 'data-show-caption'=>false, 'class'=>'rotate-1']) ?>
