		...
		<?= $this->Form->create($seller,['id'=>"jvalidate",'class'=>"form-horizontal"]) ?>  
			<div class="panel panel-default">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group">                                        
								...
								<div class="col-md-9 col-xs-12">
									<?php //$this->Form->control('gstin_holder_address',['class'=>'form-control','placeholder'=>'GSTIN Address','label'=>false,'rows'=>4]) ?>
								</div>
							</div-->
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="table-responsive">
							<table class="table table-bordered main_table1">
								<thead>
									<tr> 
										<th><?= ('Driver Name') ?></th>
										<th><?= ('Mobile') ?></th>
								...
								<tbody class="MainTbody1">  
									<tr class="MainTr1">
			
										<td width="" valign="top">
											 
											<?= $this->Form->control('drivers_name',['class'=>'form-control drivers_name','label'=>false]) ?>
										</td>
										<td width="20%" valign="top">
											 
											<?= $this->Form->control('drivers_mobile_no',['class'=>'form-control drivers_mobile_no ','label'=>false]) ?>
										</td>
										<td width="20%" valign="top">
											<?= $this->Form->control('drivers_user_name',['class'=>'form-control drivers_user_name','label'=>false]) ?>
										</td>
										<td width="20%" valign="top">
											<?= $this->Form->control('drivers_password ',['class'=>'form-control drivers_password','label'=>false,'type'=>'password']) ?>
										</td>
...
<?php
   $js='var jvalidate = $("#jvalidate").validate({
		...
		$(document).on("blur",".balance",function(){ 
			...
			if(main_amt>0 && bill_accounting=="yes"){ alert();
					$(".window").show();
					AddRefRow();
				}
		...
		renameRows1();
		function renameRows1(){
				var i=0; 
				$(".main_table1 tbody tr").each(function(){
					$(this).find("td:nth-child(1) input.drivers_name").attr({name:"drivers["+i+"][name]",id:"drivers-"+i+"-name"});
					$(this).find("td:nth-child(2) input.drivers_mobile_no").attr({name:"drivers["+i+"][mobile_no]",id:"drivers-"+i+"-mobile_no"});
					$(this).find("td:nth-child(3) input.drivers_user_name").attr({name:"drivers["+i+"][user_name]",id:"drivers-"+i+"-user_name"});
					$(this).find("td:nth-child(4) input.drivers_password").attr({name:"drivers["+i+"][password]",id:"drivers-"+i+"-password"});
