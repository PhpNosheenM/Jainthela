	...
	<table class="GeneratedTable">
			<thead> 
				...
				<tr>
					<td colspan="3" rowspan="2" width="50%">
							Customer <br>
						<b>'.h(@$Orders->customer->firm_name).'</b>
						<br>
						<font size="13px">('.h(@$Orders->customer->firm_address).')
						<br>
						Name: '.h(@$Orders->customer->name).' | 
						PH: '.h(@$Orders->customer->username).'
						<br>
						GSTIN/UIN : '.h(@$Orders->customer->gstin).'
						</font>
					</td>
					...
					<td width="25%">
						<font size="15px">
							Receiver Name
							<br>
							<b>'.h(@$Orders->customer->customer_addresses->receiver_name).'</b>
						</font>
						</td>
					<td width="25%">
						<font size="15px">
							Receiver Mobile No. 
							<br>
							<b>'.h(@$Orders->customer->customer_addresses->mobile_no).'</b>
						</font>
					</td>
				</tr>
