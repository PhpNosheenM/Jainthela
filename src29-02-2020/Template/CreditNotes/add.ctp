							...
							<table id="MainTable" class="table table-condensed table-striped" width="100%">
								...
								<tfoot>
									<tr style="border-top:double;">
										...
										<td valign="top"><input type="text" class="form-control input-sm rightAligntextClass noBorder " name="total_debit_amount" id="totalMainDr" readonly></td>
										<td valign="top"><input type="text" class="form-control input-sm rightAligntextClass noBorder" name="total_credit_amount" id="totalMainCr" readonly></td>
										<td></td>
									</tr>
								</tfoot>
							</table>
