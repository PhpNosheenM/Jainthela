							...
							<table class="table table-bordered">
								...
								<tbody>                                            
									...
									<tr>
										...
										<td>
										<?php echo $this->Form->input('item_ledgers['.$i.'][quantity]', ['label' => false,'class' => 'form-control input-sm wastage_quantity ','placeholder'=>'Wastage','total_qt'=>$showItem['stock']]); ?>
										<?php echo $this->Form->input('item_ledgers['.$i.'][item_variation_id]', ['label' => false,'class' => 'form-control input-sm wastage_quantity ','placeholder'=>'Wastage','value'=>$showItem['item_variation_id'],'type'=>'hidden']); ?>
										<?php echo $this->Form->input('item_ledgers['.$i.'][item_id]', ['label' => false,'class' => 'form-control input-sm wastage_quantity ','placeholder'=>'Wastage','value'=>$showItem['item_id'],'type'=>'hidden']); ?>
										<?php echo $this->Form->input('item_ledgers['.$i.'][rate]', ['label' => false,'class' => 'form-control input-sm wastage_quantity ','placeholder'=>'Wastage','value'=>$showItem['unit_rate'],'type'=>'hidden']); ?>
										</td>
										<td><?php echo $this->Form->input('actual_quantity', ['label' => false,'class' => 'form-control input-sm  actual_quantity','placeholder'=>'Actual','total_qt'=>$showItem['stock']]); ?></td>
									</tr>
									 <?php } ?>
									<tr>
