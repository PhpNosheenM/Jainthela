...
use App\Model\Table\WastageVoucherRowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\WastageVoucherRowsTable Test Case
 */
class WastageVoucherRowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\WastageVoucherRowsTable
     */
    public $WastageVoucherRows;
     ...
     */
    public $fixtures = [
        'app.wastage_voucher_rows',
        'app.wastage_vouchers',
        'app.cities',
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('WastageVoucherRows') ? [] : ['className' => WastageVoucherRowsTable::class];
        $this->WastageVoucherRows = TableRegistry::get('WastageVoucherRows', $config);
    }
