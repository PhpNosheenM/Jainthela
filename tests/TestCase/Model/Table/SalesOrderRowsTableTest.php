...
use App\Model\Table\SalesOrderRowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\SalesOrderRowsTable Test Case
 */
class SalesOrderRowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\SalesOrderRowsTable
     */
    public $SalesOrderRows;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('SalesOrderRows') ? [] : ['className' => SalesOrderRowsTable::class];
        $this->SalesOrderRows = TableRegistry::get('SalesOrderRows', $config);
    }
