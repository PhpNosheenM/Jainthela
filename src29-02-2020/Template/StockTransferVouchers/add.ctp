                            ...
                            <div class="portlet-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="main_table" class="table table-condensed table-bordered" style="margin-bottom: 4px;" width="70%">
                                            <thead>
                                                <tr align="left">
                                            ...
                                            foreach($grns->grn_rows as $grn_row){
											  ...
											  $pending_qty=$grn_row->total_quantity;
											  if($pending_qty > 0){
                                                ?>
                                                ...
                                                <tr class="main_tr" class="tab">
                                                    ...
                                                    <td width="45%">
                                                        <?php 
                                                        echo $this->Form->select('grn_rows_id',[$grn_row->id=>$grn_row->item->name.' ('.$grn_row->unit_variation->visible_variation.' )'], ['label' => false,'class' => 'form-control grn_rows_id','required'=>'required']); ?>
                                                        <span class="itemQty" style="color:red ;font-size:10px;">Available stock is <?php 
														echo $convert_qty= $grn_row->total_quantity; ?>  </span>
                                                    ...
                                                    <td width="50%" >
                                                        <table class="item_variation">
                                                            ...
                                                            foreach($grn_row->item->item_variations as $item_variation){ 
                                                                    $purchase_rate=$grn_row->purchase_rate;
                                                                    $itemOptions[]=['value'=>$item_variation->id,'text'=>$item_variation->unit_variation->visible_variation,'convert_qty'=>$item_variation->unit_variation->convert_unit_qty,'purchase_rate'=>$purchase_rate,'unit_variation_id'=>$item_variation->unit_variation->id];
                                                            }
                                                            ...
                                                            <tr>
                                                                <td>
                                                                     <?php 
                                                                    echo $this->Form->select('item_id',$itemOptions, ['label' => false,'class' => 'form-control item_variation','required'=>'required','value'=>$itemVar[$grn_row->item_id][$grn_row->unit_variation_id]]); ?>
                                                                      <?php 
         ...
         $(document).on('keyup','.quantity',function(){ 
            ...
            var item_quantity =parseFloat($(this).closest('table').closest('tr.main_tr').find('td:eq(1) input.item_quantity').val());
             $(this).closest('tbody').find('tr').each(function(){ 
                ...
                variation_stock += round(quantity,2);
            });
