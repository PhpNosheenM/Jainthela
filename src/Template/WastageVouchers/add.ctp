							...
							<table class="table table-bordered">
								...
								<tbody>                                            
									...
									<tr>
										...
										<td>
										<?php echo $this->Form->input('wastage_voucher_rows['.$i.'][quantity]', ['label' => false,'class' => 'form-control input-sm wastage_quantity ','placeholder'=>'Wastage','total_qt'=>$showItem['stock']]); ?>
