...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Delivery Time'), ['action' => 'edit', $deliveryTime->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Delivery Time'), ['action' => 'delete', $deliveryTime->id], ['confirm' => __('Are you sure you want to delete # {0}?', $deliveryTime->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Delivery Times'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Delivery Time'), ['action' => 'add']) ?> </li>
...
<div class="deliveryTimes view large-9 medium-8 columns content">
    <h3><?= h($deliveryTime->id) ?></h3>
    <table class="vertical-table">
        <tr>
            <th scope="row"><?= __('City') ?></th>
            <td><?= $deliveryTime->has('city') ? $this->Html->link($deliveryTime->city->name, ['controller' => 'Cities', 'action' => 'view', $deliveryTime->city->id]) : '' ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= $this->Number->format($deliveryTime->id) ?></td>
        </tr>
        <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($deliveryTime->orders)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($deliveryTime->orders as $orders): ?>
            <tr>
                <td><?= h($orders->id) ?></td>
