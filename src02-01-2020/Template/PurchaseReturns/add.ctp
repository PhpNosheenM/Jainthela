							...
							<table class="table table-bordered main_table">
								<thead>
									<tr align="center">
										...
										<th rowspan="2" style="text-align:left;width:280px;"><label>Item<label></th>
										
										<th rowspan="2" style="text-align:center;width:150px; "><label>Unit Variation<label></th>
									...
									<tr class="MainTr">
										<td  valign="top">1</td>
										 <td width="">
											...
											<input type="hidden" value="<?php echo $purchase_invoice_row->item->gst_type; ?>" class="gst_type" >
										</td>
										<td width="">
											<?php echo $purchase_invoice_row->unit_variation->visible_variation; ?>
								 ...
								 ?>
									<tr class="MainTr">
										<td  valign="top">1</td>
										 <td width="">
											<?php 
											$merge=$purchase_invoice_row->item_variations_data->item->name.'('.@$purchase_invoice_row->item_variations_data->unit_variation->visible_variation.')';
											echo @$merge;  ?>
							...
							<center><h3>Against Refrence</h3></center>
								...
								<table width="60%" style="font-size:14px;">
									...
									<tr>
										...
										<td  style="text-align:right;"><?= $this->Form->control('debit',['class'=>'form-control total_amt','label'=>false,'readonly']) ?></td>
									</tr>
								</table>
							<?php } ?>
