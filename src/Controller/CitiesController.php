        ...
        if ($this->request->is(['post','put'])) {
			...
			if ($this->Cities->save($city)) {
				...
				$gstLedgerEntrys=[
					...
					['name'=>'Tds Account', 'accounting_group_id'=>$cur_assets_id->id,'city_id'=>$city->id,'bill_to_bill_accounting'=>'no','gst_figure_id'=>null,'tax_percentage'=>0,'input_output'=>null,'gst_type'=>null,'round_off'=>0,'cash'=>0,'flag'=>1,'ccavenue'=>'no','ccavenue_charges'=>'no','tds_account'=>'yes'],
