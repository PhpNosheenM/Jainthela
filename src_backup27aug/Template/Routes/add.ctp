		...
		<?= $this->Form->create($route,['id'=>'jvalidate','class'=>'form-horizontal','type'=>'file']) ?>  
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><strong> Route Add</strong></h3>
				</div>
					...
					<div class="row col-md-6">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-9">                                            
									<?= $this->Form->select('location_id',$locations,['empty'=>'---Select--Warehouse---','class'=>'form-control location_id','label'=>false, 'data-live-search'=>true]) ?>
								</div>
							</div>
								...
								<tbody class="MainTbody">  
									<tr class="MainTr">
										<td width="60%" valign="top">
											<?= $this->Form->select('landmark_id',$landmarks,['empty'=>'---Select--Area---','class'=>'form-control lnd','label'=>false, 'data-live-search'=>true]) ?>
										</td>
