...
class AppNotificationsTable extends Table
{
    ...
    public function initialize(array $config)
    {
		...
		$this->belongsTo('ItemVariationsView', [
		...
		$this->belongsTo('ComboOffersView', [
